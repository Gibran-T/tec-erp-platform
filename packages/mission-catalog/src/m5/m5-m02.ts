...
export const M5_M02 = {
  ...
  "missionCode": "M5-M02",
  "moduleCode": "M5",
  "title": "Décider un transfert inter-DC",
  ...
  "unlockExplanation": "Complétez d'abord « Analyser les stocks et le signal de reapprovisionnement ».",
  "sequence": 2,
  "estimatedMinutes": 40,
  ...
  "contextItems": [
    {
      ...
      "body": "DC-MTL : 52 unités, couverture 47 jours. DC-TRT : 0 unite, couverture 0 jour. Demande TRT : 20 unités/semaine post-canicule.",
      "required": true
    },
    {
      "key": "ctx-transfer-request",
      "title": "Demande transfert STO-4512",
      "body": "Transfert propose : 20 unités SKU-HVAC-4421 DC-MTL vers DC-TRT. Tom confirme disponibilite physique au comptage gemba.",
      "required": true
    },
    {
      "key": "ctx-freight-options",
      "title": "Options fret et trésorerie",
      "body": "Express 24 h : 680 CAD (impact trésorerie immediat). Standard 3 jours : 290 CAD (risque 2 clients en attente). Marc : plafond urgence 750 CAD sans comite.",
      "required": true
    }
  ],
  "interactions": [
    {
      ...
      "options": [
        ...
        {
          "key": "order-only",
          "label": "Commander directement 40 unités sans transfert"
        },
        {
          "key": "wait",
    ...
    },
    {
      ...
      "prompt": "Recommandez-vous le fret express (680 CAD) ou standard (290 CAD) pour STO-4512. Justifiez l'arbitrage service client vs trésorerie.",
      "scoring": {
        "maxPoints": 15,
        "requiredConcepts": [
          "fret",
