...
export const WORKSPACE_APPS: readonly WorkspaceAppDefinition[] = [
  ...
  { id: "calendrier", label: "Calendrier", access: "preparing", sidebarOrder: 15, launcherOrder: 15 },
  {
  ...
  { id: "profil", label: "Mon profil", access: "day1", sidebarOrder: 17, launcherOrder: 17 },
];
