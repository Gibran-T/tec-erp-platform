      ...
      <div className="sap-iee2e-poc__shell">
        <header className="sap-iee2e-poc__topbar">
          <div className="sap-iee2e-poc__brand">
            <strong>{embedded ? "TEC.ERP · Parcours SAP" : "TEC.ERP · PoC visuelle"}</strong>
            <span>Accompagnement pédagogique du parcours officiel SAP Learning</span>
          </div>
        ...
        {view === "workspace" ? (
          ...
          >
            ...
            <div className="sap-iee2e-poc__module-ghost">
              Coussins lab M1–M10 (optionnels — pas le calendrier Collège S1–S10)
            </div>
          </section>
        ) : null}
          ...
          <section data-testid="poc-student-parcours" aria-labelledby="poc-parcours-title">
            ...
            <div className="sap-iee2e-poc__grid-2" style={{ marginTop: "1rem" }}>
              <article className="sap-iee2e-poc__card" id="poc-student-progression">
                <h2 className="sap-iee2e-poc__h2">Progression jusqu’au SAP Achievement</h2>
                <p className="sap-iee2e-poc__muted">
                  Titres et durées issus de SAP Learning FR. États = déclaration étudiante (MOCK
                  interactif).
                </p>
            ...
            <div className="sap-iee2e-poc__grid-2" style={{ marginTop: "1rem" }}>
              <article className="sap-iee2e-poc__card">
                ...
                <p>
                  ...
                  <a href={SAP_IEE2E_OFFICIAL_FR_URL} target="_blank" rel="noopener noreferrer">
...
function CohortRow(props: { readonly row: CohortStudentRow }): ReactNode {
  const { row } = props;
  return (
    <tr>
      <td>{row.name}</td>
      ...
      <td>
        <button type="button" className="sap-iee2e-poc__btn sap-iee2e-poc__btn--secondary">
          Ajouter une note (démo)
        </button>
      </td>
    </tr>
  );
